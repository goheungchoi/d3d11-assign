...
inline const AlphaMode (&EnumValuesAlphaMode())[3] {
  static const AlphaMode values[] = {AlphaMode_kOpaque, AlphaMode_kMask,
                                     AlphaMode_kBlend};
  return values;
}

inline const char *const *EnumNamesAlphaMode() {
  static const char *const names[4] = {"kOpaque", "kMask", "kBlend", nullptr};
  return names;
}

inline const char *EnumNameAlphaMode(AlphaMode e) {
  if (::flatbuffers::IsOutRange(e, AlphaMode_kOpaque, AlphaMode_kBlend))
    return "";
...
struct TexCoord FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  float u() const { return GetField<float>(VT_U, 0.0f); }
  float v() const { return GetField<float>(VT_V, 0.0f); }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<float>(verifier, VT_U, 4) &&
           VerifyField<float>(verifier, VT_V, 4) && verifier.EndTable();
  }
};
...
struct TexCoordBuilder {
  ...
  void add_u(float u) { fbb_.AddElement<float>(TexCoord::VT_U, u, 0.0f); }
  void add_v(float v) { fbb_.AddElement<float>(TexCoord::VT_V, v, 0.0f); }
...
inline ::flatbuffers::Offset<TexCoord> CreateTexCoord(
    ::flatbuffers::FlatBufferBuilder &_fbb, float u = 0.0f, float v = 0.0f) {
...
struct Vec3 FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<float>(verifier, VT_Z, 4) && verifier.EndTable();
  }
};
...
struct Vec3Builder {
  ...
  explicit Vec3Builder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline ::flatbuffers::Offset<Vec3> CreateVec3(
    ::flatbuffers::FlatBufferBuilder &_fbb, float x = 0.0f, float y = 0.0f,
    float z = 0.0f) {
...
struct Vec4 FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<float>(verifier, VT_W, 4) && verifier.EndTable();
  }
};
...
struct Vec4Builder {
  ...
  explicit Vec4Builder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct Material FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  GameResource::AlphaMode alphaMode() const {
    return static_cast<GameResource::AlphaMode>(
        GetField<int16_t>(VT_ALPHAMODE, 0));
  }
  float alphaCutoff() const { return GetField<float>(VT_ALPHACUTOFF, 0.0f); }
  bool doubleSided() const { return GetField<uint8_t>(VT_DOUBLESIDED, 0) != 0; }
  bool Verify(::flatbuffers::Verifier &verifier) const {
...
struct MaterialBuilder {
  ...
  void add_albedoFactor(
      ::flatbuffers::Offset<GameResource::Vec4> albedoFactor) {
    fbb_.AddOffset(Material::VT_ALBEDOFACTOR, albedoFactor);
  }
  void add_albedoTexture(
      ::flatbuffers::Offset<::flatbuffers::String> albedoTexture) {
  ...
  void add_metallicRoughnessTexture(
      ::flatbuffers::Offset<::flatbuffers::String> metallicRoughnessTexture) {
    fbb_.AddOffset(Material::VT_METALLICROUGHNESSTEXTURE,
                   metallicRoughnessTexture);
  }
  void add_normalTexture(
      ::flatbuffers::Offset<::flatbuffers::String> normalTexture) {
    fbb_.AddOffset(Material::VT_NORMALTEXTURE, normalTexture);
  }
  void add_occlusionTexture(
      ::flatbuffers::Offset<::flatbuffers::String> occlusionTexture) {
  ...
  void add_emissiveTexture(
      ::flatbuffers::Offset<::flatbuffers::String> emissiveTexture) {
    fbb_.AddOffset(Material::VT_EMISSIVETEXTURE, emissiveTexture);
  }
  void add_alphaMode(GameResource::AlphaMode alphaMode) {
    fbb_.AddElement<int16_t>(Material::VT_ALPHAMODE,
                             static_cast<int16_t>(alphaMode), 0);
  }
  ...
  void add_doubleSided(bool doubleSided) {
    fbb_.AddElement<uint8_t>(Material::VT_DOUBLESIDED,
                             static_cast<uint8_t>(doubleSided), 0);
  }
...
inline ::flatbuffers::Offset<Material> CreateMaterial(
    ...
    float alphaCutoff = 0.0f, bool doubleSided = false) {
...
inline ::flatbuffers::Offset<Material> CreateMaterialDirect(
    ...
    ::flatbuffers::Offset<GameResource::Vec4> albedoFactor = 0,
    const char *albedoTexture = nullptr, float metallicFactor = 0.0f,
    float roughnessFactor = 0.0f,
    const char *metallicRoughnessTexture = nullptr,
    const char *normalTexture = nullptr, const char *occlusionTexture = nullptr,
    float emissiveFactor = 0.0f, const char *emissiveTexture = nullptr,
    GameResource::AlphaMode alphaMode = GameResource::AlphaMode_kOpaque,
    float alphaCutoff = 0.0f, bool doubleSided = false) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto albedoTexture__ = albedoTexture ? _fbb.CreateString(albedoTexture) : 0;
  auto metallicRoughnessTexture__ =
      metallicRoughnessTexture ? _fbb.CreateString(metallicRoughnessTexture)
                               : 0;
  auto normalTexture__ = normalTexture ? _fbb.CreateString(normalTexture) : 0;
  auto occlusionTexture__ =
      occlusionTexture ? _fbb.CreateString(occlusionTexture) : 0;
  auto emissiveTexture__ =
      emissiveTexture ? _fbb.CreateString(emissiveTexture) : 0;
  return GameResource::CreateMaterial(
      _fbb, name__, albedoFactor, albedoTexture__, metallicFactor,
      roughnessFactor, metallicRoughnessTexture__, normalTexture__,
      occlusionTexture__, emissiveFactor, emissiveTexture__, alphaMode,
...
struct AABB FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_MIN) &&
           verifier.VerifyTable(min()) && VerifyOffset(verifier, VT_MAX) &&
           verifier.VerifyTable(max()) && verifier.EndTable();
  }
};
...
struct AABBBuilder {
  ...
  explicit AABBBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct Vertex FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_POSITION) &&
           ...
           VerifyOffset(verifier, VT_COLOR) && verifier.VerifyTable(color()) &&
           verifier.EndTable();
  }
};
...
struct VertexBuilder {
  ...
  explicit VertexBuilder(::flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
struct Mesh FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<::flatbuffers::Offset<GameResource::Vertex>> *
  vertices() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<GameResource::Vertex>> *>(VT_VERTICES);
  }
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) && VerifyOffset(verifier, VT_AABB) &&
           ...
           verifier.VerifyString(material()) && verifier.EndTable();
  }
};
...
struct MeshBuilder {
  ...
  void add_vertices(
      ::flatbuffers::Offset<
          ::flatbuffers::Vector<::flatbuffers::Offset<GameResource::Vertex>>>
          vertices) {
    fbb_.AddOffset(Mesh::VT_VERTICES, vertices);
  }
  void add_indices(
      ::flatbuffers::Offset<::flatbuffers::Vector<uint32_t>> indices) {
...
inline ::flatbuffers::Offset<Mesh> CreateMeshDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb, const char *name = nullptr,
    ::flatbuffers::Offset<GameResource::AABB> aabb = 0,
    const std::vector<::flatbuffers::Offset<GameResource::Vertex>> *vertices =
        nullptr,
    const std::vector<uint32_t> *indices = nullptr,
    const char *material = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto vertices__ =
      vertices ? _fbb.CreateVector<::flatbuffers::Offset<GameResource::Vertex>>(
                     *vertices)
               : 0;
  auto indices__ = indices ? _fbb.CreateVector<uint32_t>(*indices) : 0;
  auto material__ = material ? _fbb.CreateString(material) : 0;
  return GameResource::CreateMesh(_fbb, name__, aabb, vertices__, indices__,
                                  material__);
}
...
struct GeometryNode FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t parent() const { return GetField<int32_t>(VT_PARENT, 0); }
  int32_t firstChild() const { return GetField<int32_t>(VT_FIRSTCHILD, 0); }
  int32_t nextSibling() const { return GetField<int32_t>(VT_NEXTSIBLING, 0); }
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *
  meshes() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<::flatbuffers::String>> *>(VT_MESHES);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           verifier.VerifyString(name()) &&
           ...
           verifier.VerifyVectorOfStrings(meshes()) && verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<GeometryNode> CreateGeometryNode(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::String> name = 0, int32_t level = 0,
    int32_t parent = 0, int32_t firstChild = 0, int32_t nextSibling = 0,
    ::flatbuffers::Offset<
        ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>>>
        meshes = 0) {
...
inline ::flatbuffers::Offset<GeometryNode> CreateGeometryNodeDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb, const char *name = nullptr,
    int32_t level = 0, int32_t parent = 0, int32_t firstChild = 0,
    int32_t nextSibling = 0,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *meshes =
        nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto meshes__ =
      meshes ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(
                   *meshes)
             : 0;
  return GameResource::CreateGeometryNode(_fbb, name__, level, parent,
                                          firstChild, nextSibling, meshes__);
}
...
struct GeometryModel FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<
      ::flatbuffers::Offset<GameResource::GeometryNode>> *
  nodes() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<GameResource::GeometryNode>> *>(VT_NODES);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *
  meshes() const {
    return GetPointer<const ::flatbuffers::Vector<
  ...
  materials() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<::flatbuffers::String>> *>(VT_MATERIALS);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<::flatbuffers::String>> *
  textures() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<::flatbuffers::String>> *>(VT_TEXTURES);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           ...
           verifier.VerifyVectorOfStrings(textures()) && verifier.EndTable();
  }
};
...
inline ::flatbuffers::Offset<GeometryModel> CreateGeometryModelDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb, const char *name = nullptr,
    const std::vector<::flatbuffers::Offset<GameResource::GeometryNode>>
        *nodes = nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *meshes =
        nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *materials =
        nullptr,
    const std::vector<::flatbuffers::Offset<::flatbuffers::String>> *textures =
        nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto nodes__ =
      nodes ? _fbb.CreateVector<
                  ::flatbuffers::Offset<GameResource::GeometryNode>>(*nodes)
            : 0;
  auto meshes__ =
      meshes ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(
                   *meshes)
  ...
  auto textures__ =
      textures
          ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(
                *textures)
          : 0;
  return GameResource::CreateGeometryModel(_fbb, name__, nodes__, meshes__,
                                           materials__, textures__);
}
...
inline const GameResource::GeometryModel *GetSizePrefixedGeometryModel(
    const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<GameResource::GeometryModel>(buf);
}

inline bool VerifyGeometryModelBuffer(::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<GameResource::GeometryModel>(nullptr);
}

inline bool VerifySizePrefixedGeometryModelBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<GameResource::GeometryModel>(
      nullptr);
}
